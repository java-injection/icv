 ...
 * @author Luca
 */
public class InfoPanelLayer extends MyLayer<JComponent> {
...
//    private List<AdditionalExtraSurfacePanel> extraSurfaces = new LinkedList<AdditionalExtraSurfacePanel>();
    private AdditionalExtraSurfacePanel extraSurfacePanel = null;
...
//        this.installedComponent.add(panel.getContainer());
//        
//    }
    public void setExtraSurfacePanel(AdditionalExtraSurfacePanel extraSurfacePanel) {
        this.extraSurfacePanel = extraSurfacePanel;
    }
...
//        this.installedComponent.add((JComponent)this.extraSurfacePanel.getContainer());
        if (this.extraSurfacePanel != null) {
            this.extraSurfacePanel.getContainer().setBackground(new Color(255, 0, 0, 100));
            this.extraSurfacePanel.getContainer().setBounds(
                    x,
                    y,
                    this.extraSurfacePanel.getContainer().getPreferredSize().width,
                    this.extraSurfacePanel.getContainer().getPreferredSize().width
            );
        }
...
//        g2.dispose();
    ...
    private boolean isMouseInsideClock(int _x, int _y) {
        return (_x >= x && _x <= x + clockWidth && _y >= y && _y <= y + clochHeight);
    }
