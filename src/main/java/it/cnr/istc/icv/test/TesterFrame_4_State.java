 ...
 * @author Luca
 */
public class TesterFrame_4_State extends javax.swing.JFrame {
...
//            bMap.put(false, "Chiuso");
    ...
    private void jButton_test3ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButton_test3ActionPerformed
        ...
        MultiStateContainerSupporter b1 = new MultiStateContainerSupporter("Physiological Status");
        b1.mapValue("Warning", Color.yellow);
        b1.mapValue("Danger", Color.red);
        b1.mapValue("No Problems", Color.green);
        
        b1.addStateData(new StateDataSupporter("Warning", "a", new Date(113, 9, 5, 10, 0, 0)));
        b1.addStateData(new StateDataSupporter("Danger", "a", new Date(113, 9, 5, 11, 0, 0)));
        b1.addStateData(new StateDataSupporter("No Problems", "a", new Date(113, 9, 5, 11, 30, 0)));
        b1.addStateData(new StateDataSupporter("Danger", "a", new Date(113, 9, 5, 11, 45, 0)));
        b1.setDefaultColor(Color.green);
...
//            bMap.put(false, "Chiuso");
    ...
    //        b1.addData(bs3);
            ...
            Logger.getLogger(TesterFrame_4_State.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//            ActivityContainerSupporter a1 = new ActivityContainerSupporter("A1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TesterFrame_4_State.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TesterFrame_4_State().setVisible(true);
            }
        });
    }
