...
/**
 * The base class for all {@link javax.swing.MyJLayer}'s UI delegates.
 * <p/>
 * {@link #paint(java.awt.Graphics, javax.swing.JComponent)} method performs the
 * painting of the {@code MyJLayer}
 * and {@link #eventDispatched(AWTEvent, MyJLayer)} method is notified
 * about any {@code AWTEvent}s which have been generated by a {@code MyJLayer}
 ...
 * by multiple {@code MyJLayer}s or not shareable.
 *
 * @param <V> one of the super types of {@code MyJLayer}'s view component
 *
 * @see MyJLayer#setUI(LayerUI)
 * @see MyJLayer#setView(Component)
 * @see MyJLayer#getView()
 * @since 1.7
 *
 * @author Alexander Potochkin
 */
public class MyLayer<V extends Component>
     ...
     * <p/>
     * <b>Note:</b> Events are processed only for displayable {@code MyJLayer}s.
     *
     * @param e the event to be dispatched
     * @param l the layer this LayerUI is set to
     *
     * @see MyJLayer#setLayerEventMask(long)
     ...
     */
    public void eventDispatched(AWTEvent e, MyJLayer<? extends V> l){
    ...
    /**
     * Processes component events occurring on the {@link MyJLayer}
     * or any of its subcomponents.
     * <p/>
     * This method is not called unless component events are
     * enabled for the {@code MyJLayer} objects, this {@code LayerUI} is set to.
     ...
     */
    protected void processComponentEvent(ComponentEvent e, MyJLayer<? extends V> l) {
    }

    /**
     * Processes focus events occurring on the {@link MyJLayer}
     * or any of its subcomponents.
     * <p/>
     ...
     * @see #uninstallUI(javax.swing.JComponent)
     */
    protected void processFocusEvent(FocusEvent e, MyJLayer<? extends V> l) {
    }

    /**
     * Processes key events occurring on the {@link MyJLayer}
     * or any of its subcomponents.
     * <p/>
     ...
     * @see #uninstallUI(javax.swing.JComponent)
     */
    protected void processKeyEvent(KeyEvent e, MyJLayer<? extends V> l) {
    }

    /**
     * Processes mouse events occurring on the {@link MyJLayer}
     * or any of its subcomponents.
     * <p/>
     ...
     * @see #uninstallUI(javax.swing.JComponent)
     */
    protected void processMouseEvent(MouseEvent e, MyJLayer<? extends V> l) {
    }

    /**
     * Processes mouse motion event occurring on the {@link MyJLayer}
     * or any of its subcomponents.
     * <p/>
     ...
     * @see #uninstallUI(javax.swing.JComponent)
     */
    protected void processMouseMotionEvent(MouseEvent e, MyJLayer<? extends V> l) {
    }

    /**
     * Processes mouse wheel event occurring on the {@link MyJLayer}
     * or any of its subcomponents.
     * <p/>
     ...
     * @see #uninstallUI(javax.swing.JComponent)
     */
    protected void processMouseWheelEvent(MouseWheelEvent e, MyJLayer<? extends V> l) {
    }

    /**
     * Processes input event occurring on the {@link MyJLayer}
     * or any of its subcomponents.
     * <p/>
     ...
     * @see #uninstallUI(javax.swing.JComponent)
     */
    protected void processInputMethodEvent(InputMethodEvent e, MyJLayer<? extends V> l) {
    }

    /**
     * Processes hierarchy event occurring on the {@link MyJLayer}
     * or any of its subcomponents.
     * <p/>
     ...
     * @see #uninstallUI(javax.swing.JComponent)
     */
    protected void processHierarchyEvent(HierarchyEvent e, MyJLayer<? extends V> l) {
    }

    /**
     * Processes hierarchy bounds event occurring on the {@link MyJLayer}
     * or any of its subcomponents.
     * <p/>
     ...
     * @see #uninstallUI(javax.swing.JComponent)
     */
    protected void processHierarchyBoundsEvent(HierarchyEvent e, MyJLayer<? extends V> l) {
    }

    /**
     * Invoked when {@link javax.swing.MyJLayer#updateUI()} is called
     * by the {@code MyJLayer} this {@code LayerUI} is set to.
     *
     * @param l the {@code MyJLayer} which UI is updated
     */
    public void updateUI(MyJLayer<? extends V> l){
    }

    /**
     * Configures the {@code MyJLayer} this {@code LayerUI} is set to.
     * The default implementation registers the passed {@code MyJLayer} component
     * as a {@code PropertyChangeListener} for the property changes of this {@code LayerUI}.
     *
     * @param c the {@code MyJLayer} component where this UI delegate is being installed
     */
    public void installUI(JComponent c) {
        addPropertyChangeListener((MyJLayer) c);
    }

    /**
     * Reverses the configuration which was previously set
     * in the {@link #installUI(JComponent)} method.
     * The default implementation unregisters the passed {@code MyJLayer} component
     * as a {@code PropertyChangeListener} for the property changes of this {@code LayerUI}.
     *
     * @param c the component from which this UI delegate is being removed.
     */
    public void uninstallUI(JComponent c) {
        removePropertyChangeListener((MyJLayer) c);
    }
     ...
     * and enables updating every {@code MyJLayer}
     * this {@code LayerUI} instance is set to.
     *
     * @param evt the PropertyChangeEvent generated by this {@code LayerUI}
     * @param l the {@code MyJLayer} this LayerUI is set to
     */
    public void applyPropertyChange(PropertyChangeEvent evt, MyJLayer<? extends V> l) {
    }

    /**
     * If the {@code MyJLayer}'s view component is not {@code null},
     * this calls the view's {@code getBaseline()} method.
     * Otherwise, the default implementation is called.
     *
     * @param c {@code MyJLayer} to return baseline resize behavior for
    ...
    /**
     * Causes the passed instance of {@code MyJLayer} to lay out its components.
     *
     * @param l the {@code MyJLayer} component where this UI delegate is being installed
     */
    public void doLayout(MyJLayer<? extends V> l) {
     ...
     *
     * @param c {@code MyJLayer} to return preferred size for
     * @return preferred size for the passed {@code MyJLayer}
     */
     ...
     *
     * @param c {@code MyJLayer} to return preferred size for
     * @return minimal size for the passed {@code MyJLayer}
     */
     ...
     *
     * @param c {@code MyJLayer} to return preferred size for
     * @return maximum size for the passed {@code MyJLayer}
     */
    ...
    /**
     * Paints the specified region in the {@code MyJLayer} this {@code LayerUI} is set to, immediately.
     * <p/>
     ...
     */
    public void paintImmediately(int x, int y, int width, int height, MyJLayer<? extends V> l) {
