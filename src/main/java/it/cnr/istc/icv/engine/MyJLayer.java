 ...
 */
public final class MyJLayer<V extends Component>
        extends JComponent
    ...
    private MyLayer<? super V> layerUI;
    private JPanel glassPane;
    private long eventMask;
    private transient boolean isPainting;
    private transient boolean isPaintingImmediately;

    private static final MyJLayer.LayerEventController eventController =
            new MyJLayer.LayerEventController();
     ...
     * @see #setUI
     */
    public MyJLayer(V view) {
        this(view, new MyLayer<V>());
    }
     ...
     */
    public MyJLayer(V view, MyLayer<V> ui) {
     ...
     */
    public void setUI(MyLayer<? super V> ui) {
        this.layerUI = ui;
        super.setUI(ui);
    }
...
//                    new Rectangle());
    ...
    public JPanel createGlassPane() {
        return new MyJLayer.DefaultLayerGlassPane();
    }
    ...
    private static class LayerEventController implements AWTEventListener {
        ...
        public void eventDispatched(AWTEvent event) {
            ...
            if (source instanceof Component) {
                ...
                while (component != null) {
                    if (component instanceof MyJLayer) {
                        MyJLayer l = (MyJLayer) component;
                        MyLayer ui = l.getUI();
                        if (ui != null &&
            ...
            AccessController.doPrivileged(new PrivilegedAction<Void>() {
                public Void run() {
                    Toolkit.getDefaultToolkit().
                            addAWTEventListener(MyJLayer.LayerEventController.this, eventMask);
                    return null;
                }
            });
        ...
        private void removeAWTEventListener() {
            AccessController.doPrivileged(new PrivilegedAction<Void>() {
                public Void run() {
                    Toolkit.getDefaultToolkit().
                            removeAWTEventListener(MyJLayer.LayerEventController.this);
                    return null;
                }
            });
        }
